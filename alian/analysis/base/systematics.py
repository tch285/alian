...
TRACKING_UNCERTAINTIES = {
    "LHC22o": {
        "pT":  [0.15, 0.3, 0.5, 1, 1.3, 2.5, 25, 40,  50, 70, 100],
        "unc": [   2.5, 1.5,  2, 2.5,  3,  2,  2.5, 3.5, 5, 8]
    },
    "LHC23_thinned": {
        "pT":  [0.15, 0.3, 1.6, 2.5, 25, 40,  50, 70, 100],
        "unc": [    2,  1.5,   2, 1.5, 2,  2.5, 3.5, 6]
    },
    # this one is weird, 10 border is also 12?
    # "LHC24_ppref": {
    #     "pT":  [0.15, 1.6, 2.5, 10, 20, 25, 30, 40, 50,  70, 100],
    #     "unc": [   1.5,   2,  1.5, 2, 2.5, 3,  4, 5.5, 12, 14.5]
    # },
}
