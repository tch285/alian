...
class PythiaOTFCW(object):
    ...
    def prepare(self):
        ...
        self.user_config = ['Init:showProcesses = off', 'Init:showChangedParticleData = on', 'PhaseSpace:bias2Selection = on']

        bias_config = [
            f'PhaseSpace:pTHatMin = {self.pThat_min}',
            f'PhaseSpace:pTHatMax = {self.pThat_max}',
            f'PhaseSpace:bias2SelectionPow = {self.bias_pow}'
        ]
        self.user_config.extend(bias_config)
