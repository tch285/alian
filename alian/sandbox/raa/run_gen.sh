...
./pythia8_simple_eec.py --jet-R 0.2 --output pythia8_simple_eec_output.root --py-cmnd pythia8_pp.cmnd	--nev ${nev} --jet-pt-min ${jet_pt_min} --py-pthatmin ${jet_pt_min} --charged
